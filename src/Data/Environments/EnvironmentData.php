...
class EnvironmentData extends Data
{
    public function __construct(
        ...
        public PhpVersion $phpMajorVersion,
    ...
    public static function fromResponse(array $attributes, string $id): self
    {
        return new self(
            ...
            status: EnvironmentStatus::from($attributes['status']),
            phpMajorVersion: PhpVersion::from($attributes['php_major_version']),
            nodeVersion: NodeVersion::from($attributes['node_version']),
