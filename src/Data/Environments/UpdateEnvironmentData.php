...
class UpdateEnvironmentData extends Data
{
    public function __construct(
        ...
        public string|EnvironmentColor|Optional $color = new Optional,
        public string|Optional $branch = new Optional,
        public string|PhpVersion|Optional $phpVersion = new Optional,
        public string|NodeVersion|Optional $nodeVersion = new Optional,
        ...
        public string|CacheStrategy|Optional $cacheStrategy = new Optional,
        public string|ResponseHeadersFrame|Optional $responseHeadersFrame = new Optional,
        public string|ResponseHeadersContentType|Optional $responseHeadersContentType = new Optional,
        public string|ResponseHeadersRobotsTag|Optional $responseHeadersRobotsTag = new Optional,
        ...
        public string|FirewallRateLimitLevel|null|Optional $firewallRateLimitLevel = new Optional,
